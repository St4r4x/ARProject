...
N'hésite pas à me dire si tu veux que je committe et pousse ce `README.md` pour toi.

prendre des décisions, utiliser des capteurs pour valider des positions, se déplacer
et parfois sauter.
...
- Tester le comportement avec plusieurs cubes simultanément
- Utiliser des raycasts ou colliders comme capteurs pour vérifier la validité des positions
- Prévoir des gardes contre positions hors scène ou trop élevées

N'hésite pas à préciser si tu veux que je committe et pousse ce `README.md` pour toi.
